# Prompt-to-Image-to-Prompt Pipeline (BAGEL)
...
本项目用于验证 Prompt -> Image -> Prompt 的“可逆性/可解释性”。流程：
1) 按分桶与模板生成 prompts
2) T2I 生成图片
3) I2T 反推文本
4) 合并结果并评分
...
This project validates the reversibility of a Prompt -> Image -> Prompt pipeline:
