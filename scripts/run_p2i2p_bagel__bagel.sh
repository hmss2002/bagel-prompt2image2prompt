...
# ============================================================
# Prompt-to-Image-to-Prompt Orchestrator (v2 default)
# - Reads config values
...
CONFIG_PATH="${ROOT_DIR}/configs/p2i2p_bagel__bagel_default.yaml"
...
RUN_PREFIX="bagel__bagel"
RUN_ID=$(date +"%Y%m%d_%H%M%S")
RUN_DIR="${OUTPUT_DIR}/${RUN_PREFIX}_${RUN_ID}"
mkdir -p "${RUN_DIR}"
